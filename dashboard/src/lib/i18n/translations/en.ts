const en = {
  ...
  "sandbox.promptTitle": "Classification Prompt",
  "sandbox.promptPlaceholder": "Enter your classification rules here...",
  "sandbox.emailTitle": "Test Email",
  "sandbox.rawEmailMode": "Raw RFC822",
  ...
  "sandbox.provider": "LLM Provider",
  "sandbox.model": "Model (optional)",
  "sandbox.modelPlaceholder": "Leave empty for default",
  "sandbox.folderMode": "Folder Mode",
  "sandbox.predefined": "Predefined",
  "sandbox.autoCreate": "Auto Create",
  "sandbox.allowedFolders": "Allowed Folders",
  "sandbox.existingFolders": "Existing Folders",
  "sandbox.foldersPlaceholder": "INBOX, Work, Personal, Archive",
  "sandbox.allowedActions": "Allowed Actions",
  "sandbox.runTest": "Run Test",
  "sandbox.testing": "Testing...",
  "sandbox.resultsTitle": "Classification Results",
  "sandbox.success": "Success",
  "sandbox.failed": "Failed",
  "sandbox.tabActions": "Actions",
  "sandbox.tabPrompt": "Full Prompt",
  "sandbox.tabRaw": "Raw Response",
  "sandbox.noResponse": "No response",
  "sandbox.errorNoProvider": "Please select an LLM provider",
  "sandbox.errorNoPrompt": "Please enter a classification prompt",
  "sandbox.errorLoadingConfig": "Failed to load configuration",
  "sandbox.chars": "chars",
  "sandbox.words": "words",
